// modifications are located in the Inorder method
...
public class BinaryTree<AnyType extends Comparable<? super AnyType>> {
    ...
    // public BinaryTree(AnyType x){ root = null; root.element=x; root.left=null ;
    // root.right=null; }
    ...
    private void InOrder_modified(String exp) {
    ...
    private String PostOrder_to_String(BinaryNode<AnyType> t) {
      int idx = 0;
        ...
        for (int i = 0; i < group.length; i++) {
            group_string = group_string+(String)group[i];
        }
    ...
    public BinaryNode<AnyType> insert(BinaryNode<AnyType> t) {
        if (t == null)
            return t;// new BinaryNode<>(x, null, null);
        else if (t.left == null)
            t.left = t;
        else if (t.right == null)
            t.right = t;
    ...
    public BinaryNode<AnyType> insert(BinaryNode<AnyType> ot, BinaryNode<AnyType> t) {
        ...
        if (ot.left == null)
            ot.left = insert(ot.left, t);
        else if (ot.right == null)
            ot.right = insert(ot.right, t);
        return t;
    }
...
System.out.println();
        System.out.print("Inorder_Modified: ");
        BT.InOrder_modified(AE);
